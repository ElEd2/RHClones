...
#include "stanExports_partials_normal.h"

RCPP_MODULE(stan_fit4partials_normal_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_partials_normal")
