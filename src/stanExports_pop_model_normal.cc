...
#include "stanExports_pop_model_normal.h"

RCPP_MODULE(stan_fit4pop_model_normal_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_pop_model_normal")
