...
#include "stanExports_crypt_fission_inference.h"

RCPP_MODULE(stan_fit4crypt_fission_inference_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_crypt_fission_inference")
