...
namespace model_partials_normal_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_partials_normal");
    reader.add_event(27, 25, "end", "model_partials_normal");
    return reader;
}
#include <stan_meta_header.hpp>
class model_partials_normal
  : public stan::model::model_base_crtp<model_partials_normal> {
private:
        int N;
        vector_d age;
...
public:
    model_partials_normal(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_partials_normal_namespace::model_partials_normal";
        ...
        try {
            ...
            validate_non_negative_index("intercept_i", "N", N);
            num_params_r__ += N;
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        std::vector<int> vals_i__;
        current_statement_begin__ = 9;
        if (!(context__.contains_r("intercept_i")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable intercept_i missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("intercept_i");
        pos__ = 0U;
        validate_non_negative_index("intercept_i", "N", N);
        context__.validate_dims("parameter initialization", "intercept_i", "vector_d", context__.to_vec(N));
        Eigen::Matrix<double, Eigen::Dynamic, 1> intercept_i(N);
        size_t intercept_i_j_1_max__ = N;
        for (size_t j_1__ = 0; j_1__ < intercept_i_j_1_max__; ++j_1__) {
            intercept_i(j_1__) = vals_r__[pos__++];
        }
        try {
            writer__.vector_lub_unconstrain(0, 1, intercept_i);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable intercept_i: ") + e.what()), current_statement_begin__, prog_reader__());
        }
        current_statement_begin__ = 10;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            // model parameters
            current_statement_begin__ = 9;
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> intercept_i;
            (void) intercept_i;  // dummy to suppress unused var warning
            if (jacobian__)
                intercept_i = in__.vector_lub_constrain(0, 1, N, lp__);
            else
                intercept_i = in__.vector_lub_constrain(0, 1, N);
            current_statement_begin__ = 10;
            ...
            lp_accum__.add(gamma_log<propto__>(pop_mu, 2, 0.1));
            current_statement_begin__ = 17;
            lp_accum__.add(gamma_log<propto__>(pop_sd, 2, 0.1));
            current_statement_begin__ = 20;
            lp_accum__.add(normal_log<propto__>(intercept_i, pop_mu, pop_sd));
            current_statement_begin__ = 21;
            lp_accum__.add(binomial_log<propto__>(counts, num_crypts, intercept_i));
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
            throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_partials_normal_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        // read-transform, write parameters
        Eigen::Matrix<double, Eigen::Dynamic, 1> intercept_i = in__.vector_lub_constrain(0, 1, N);
        size_t intercept_i_j_1_max__ = N;
        for (size_t j_1__ = 0; j_1__ < intercept_i_j_1_max__; ++j_1__) {
            vars__.push_back(intercept_i(j_1__));
        }
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        for (size_t j_1__ = 0; j_1__ < intercept_i_j_1_max__; ++j_1__) {
            ...
            param_name_stream__ << "intercept_i" << '.' << j_1__ + 1;
...
typedef model_partials_normal_namespace::model_partials_normal stan_model;
#ifndef USING_R
